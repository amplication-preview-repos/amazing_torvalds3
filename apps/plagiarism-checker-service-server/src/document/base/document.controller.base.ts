...
import { PlagiarismReportFindManyArgs } from "../../plagiarismReport/base/PlagiarismReportFindManyArgs";
import { PlagiarismReport } from "../../plagiarismReport/base/PlagiarismReport";
...
export class DocumentControllerBase {
  ...
  @common.Get("/:id/plagiarismReports")
  @ApiNestedQuery(PlagiarismReportFindManyArgs)
  async findPlagiarismReports(
    @common.Req() request: Request,
    @common.Param() params: DocumentWhereUniqueInput
  ): Promise<PlagiarismReport[]> {
    const query = plainToClass(PlagiarismReportFindManyArgs, request.query);
    const results = await this.service.findPlagiarismReports(params.id, {
      ...query,
      select: {
        createdAt: true,
        details: true,
  ...
  @common.Post("/:id/plagiarismReports")
  async connectPlagiarismReports(
    @common.Param() params: DocumentWhereUniqueInput,
    @common.Body() body: PlagiarismReportWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      plagiarismReports: {
        connect: body,
  ...
  @common.Patch("/:id/plagiarismReports")
  async updatePlagiarismReports(
    @common.Param() params: DocumentWhereUniqueInput,
    @common.Body() body: PlagiarismReportWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/plagiarismReports")
  async disconnectPlagiarismReports(
    @common.Param() params: DocumentWhereUniqueInput,
    @common.Body() body: PlagiarismReportWhereUniqueInput[]
  ): Promise<void> {
    const data = {
